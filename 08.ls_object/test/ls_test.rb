...
class LsCommandTest < Minitest::Test
  ...
  def test_file_no_option
    ...
    TEXT
    assert_equal expected, LsFile.ls_files(%w[Gemfile Gemfile.lock], %w[], 13)
  end
  ...
  def test_file_r_option
    ...
    TEXT
    assert_equal expected, LsFile.ls_files(%w[Gemfile Gemfile.lock], %w[-r], 13)
  end
  ...
  def test_file_l_option
    ...
    TEXT
    assert_equal expected, LsFile.ls_files(%w[Gemfile Gemfile.lock], %w[-l], 13)
  end
  ...
  def test_file_rl_option
    expected = <<~TEXT.chomp
      ...
      -rw-r--r--  1 ryo  staff  141 11 25 23:38 Gemfile
    TEXT
    assert_equal expected, LsFile.ls_files(%w[Gemfile Gemfile.lock], %w[-l -r], 13)
  end
  ...
  def test_directory_no_option
    ...
    TEXT
    assert_equal expected, LsDirectory.ls_directories(%w[.], %w[], 13)
  end
  ...
  def test_directory_r_option
    expected = <<~TEXT.chomp
      ...
      lib             bin             Gemfile
    TEXT
    assert_equal expected, LsDirectory.ls_directories(%w[.], %w[-r], 13)
  end
  ...
  def test_directory_l_option
    ...
    TEXT
    assert_equal expected, LsDirectory.ls_directories(%w[test/test_data], %w[-l], 13)
  end
  ...
  def test_directory_a_option
    ...
    TEXT
    assert_equal expected, LsDirectory.ls_directories(%w[.], %w[-a], 13)
  end
  ...
  def test_directory_rla_option
    ...
    TEXT
    assert_equal expected, LsDirectory.ls_directories(%w[test/test_data], %w[-l -a -r], 13)
  end
end
